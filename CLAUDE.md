...
> - **Snapshots are sent at 60 Hz** (1 full : 5 delta → 10 Hz full, 50 Hz delta). The inline code comment says 20 Hz and is wrong; `docs/NETWORKING.md:86` and `docs/ARCHITECTURE.md:43` correctly state `1.0f/60.f` and only quote "20hz" as that stale code annotation.
